...
import 'package:uas_adi_364/data/database.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  TextEditingController tittleTEC = new TextEditingController();
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                        onPressed: () {
                          if (todo != null) {
                            update(todo, tittleTEC.text, detailTEC.text);
                          } else {
                            insert(tittleTEC.text, detailTEC.text);
                          }
